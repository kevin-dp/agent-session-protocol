...
export function ToolBlock({ call, result }: Props): JSX.Element {
  ...
  return (
    <div className={`tool${expanded ? ` expanded` : ``}`}>
      ...
      >
        ...
        {summary && (
          <span style={{ color: `var(--c-text-3)`, fontFamily: `var(--font-mono)`, fontSize: `0.78rem`, overflow: `hidden`, textOverflow: `ellipsis`, whiteSpace: `nowrap`, maxWidth: `25rem` }}>
            {summary}
          </span>
        )}
